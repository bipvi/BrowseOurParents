...
public record SpecieDTO(@NotNull(message = "Il campo nome comune non può essere vuoto") String nome, String nome_comune, String nome_scientifico,@URL(message = "il campo img deve essere un url") String img,
